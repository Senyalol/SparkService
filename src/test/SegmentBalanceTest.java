...
class SegmentBalanceTest {
    ...
    class EmptyEntriesTests {
        ...
        void shouldReturnZeroForEmptyEntries() {
            double balance = SparkStreamingApp.segmentBalanceFromEntries(entries);
        ...
        void shouldReturnZeroForNullTypeEntries() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 500.0, null));
            double balance = SparkStreamingApp.segmentBalanceFromEntries(entries);
    ...
    class DepositTests {
        ...
        void shouldAddDepositAmount() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 100.0, "Deposit"));
            entries.add(new SparkStreamingApp.TransactionEntry(2000L, 50.0, "Deposit"));
        ...
        void shouldHandleSingleDeposit() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 500.0, "Deposit"));
    ...
    class CreditTests {
        ...
        void shouldSubtractCreditAmount() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 200.0, "Deposit"));
            entries.add(new SparkStreamingApp.TransactionEntry(2000L, 50.0, "Credit"));
        ...
        void shouldNotGoBelowZero() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 50.0, "Deposit"));
            entries.add(new SparkStreamingApp.TransactionEntry(2000L, 100.0, "Credit"));
        ...
        void shouldHandleMultipleCredits() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 500.0, "Deposit"));
            entries.add(new SparkStreamingApp.TransactionEntry(2000L, 100.0, "Credit"));
            entries.add(new SparkStreamingApp.TransactionEntry(3000L, 50.0, "Credit"));
    ...
    class MixedTransactionsTests {
        ...
        void shouldCalculateComplexBalance() {
            entries.add(new SparkStreamingApp.TransactionEntry(1000L, 1000.0, "Deposit"));
            entries.add(new SparkStreamingApp.TransactionEntry(2000L, 300.0, "Credit"));
            entries.add(new SparkStreamingApp.TransactionEntry(3000L, 200.0, "Deposit"));
            entries.add(new SparkStreamingApp.TransactionEntry(4000L, 500.0, "Credit"));
    ...
    class ClampMTests {
        ...
        void shouldReturnPositiveValue() {
            assertEquals(100.0, SparkStreamingApp.clampM(100.0), 0.001, "Positive value should be returned as is");
            assertEquals(0.0, SparkStreamingApp.clampM(0.0), 0.001, "Zero should be returned as is");
        }

        @Test
        @DisplayName("Should return 0 for negative value")
        void shouldReturnZeroForNegative() {
            assertEquals(0.0, SparkStreamingApp.clampM(-50.0), 0.001, "Negative value should clamp to 0");
            assertEquals(0.0, SparkStreamingApp.clampM(-1000.0), 0.001, "Negative value should clamp to 0");
        }
    }
}